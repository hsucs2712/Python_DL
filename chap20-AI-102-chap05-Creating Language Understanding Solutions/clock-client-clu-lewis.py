...
def main():
    ...
    try:
        ...
        load_dotenv()             
        ls_prediction_endpoint = 'https://azclu1688.cognitiveservices.azure.com/'#os.getenv('LS_CONVERSATIONS_ENDPOINT')
        ls_prediction_key = 'ccab0ab644fc450d85d5836b8e840b4c' #os.getenv('LS_CONVERSATIONS_KEY')
