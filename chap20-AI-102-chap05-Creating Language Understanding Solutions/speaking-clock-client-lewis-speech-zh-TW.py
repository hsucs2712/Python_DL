...
def main():
    ...
    try:
        ...
        lu_app_id = '2bc90f31-0593-4fa9-a655-11125d438445'     #os.getenv('LU_APP_ID')
        lu_prediction_region = 'westus'                        #os.getenv('LU_PREDICTION_REGION')
        lu_prediction_key = 'a587e04a00d84a64bd6c038371bde2a4' #os.getenv('LU_PREDICTION_KEY')

        # Configure speech service and get intent recognizer
        # Configure speech service and get intent recognizer
        print('Speaking....in Chinese')
        speech_config = speech_sdk.SpeechConfig(subscription=lu_prediction_key, region=lu_prediction_region, speech_recognition_language='zh-TW')
        audio_config = speech_sdk.AudioConfig(use_default_microphone=True)
        recognizer = speech_sdk.intent.IntentRecognizer(speech_config, audio_config)
        #added by Lewis 20221016
